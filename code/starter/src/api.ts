...
const api = {
  list: async (): Promise<Restaurant[]> => {
    const [, ...data] = await fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vTnULUz5xvw34Fg0b4OXEszG835bjzKr1HW_DHFb4agSDgmpTh4XwdbmyWerDI4UuWNJ1t5oew6j34U/pub?output=csv', {cache: 'no-store'}).then(res => res.text()).then(text => text.split('\n'))
